...
// + narrativa de ahorro de largo plazo (docs/copy-retiro-propuesta.md, jul 2026).
...
// Narrativa: la pensión puede no alcanzar → ahorro propio. Reglas: el producto
// nunca se llama "pensión"; el gancho vive solo en el hero y en calc.btc0; sin
// afirmaciones absolutas de futuro; "ahorro" = objetivo, "compra" = operación
// (en pantallas operativas siempre "comprar", el usuario sabe qué autoriza).
const dict = {
  es: {
    // Landing
    'landing.title1': 'La pensión puede no alcanzarte.',
    'landing.title2': 'Tu ahorro empieza hoy.',
    'landing.subtitle': 'Cada vez hay menos trabajadores cotizando por más personas pensionadas. Por eso conviene construir un ahorro propio desde hoy. CompraBTC automatiza pequeñas compras de Bitcoin, desde $0.10 USDT, directo a tu billetera y bajo tu control.',
    'landing.step1': 'Conecta tu billetera',
    'landing.step2': 'Elige cuánto ahorrar y cada cuánto',
    'landing.step3': 'El agente compra Bitcoin y lo envía directo a tu billetera',
    'landing.cta': 'Empezar mi ahorro',
    'landing.note': 'Sin custodia: tus fondos permanecen en tu billetera y solo se usan dentro del límite que autorizas.',
    'landing.roadmap': 'Hoy tu plan usa Bitcoin. La visión es sumar oro y dólares digitales en la misma billetera.',
    ...
    'connect.subtitle': 'Tu agente automatiza el ahorro desde tu propia billetera. Tú defines el plan y mantienes el control de tus fondos.',
    'connect.button': 'Conectar billetera',
    'connect.loading': 'Cargando…',
    // Dashboard
    'dash.emptyTitle': 'Tu agente de ahorro',
    ...
    'dash.vault': 'Tu ahorro en Bitcoin',
    'dash.accumulated': 'Sats acumulados',
    'dash.accumulatedHint': 'comprados con la app',
    'dash.inWallet': 'En tu billetera ahora',
    ...
    'dash.loadMore': 'Ver más compras ({n} restantes)',
    'dash.withdraw': 'Retirar',
    // Retiro (enviar WBTC a una dirección)
    'wd.title': 'Retirar Bitcoin',
    'wd.subtitle': 'Envía tu Bitcoin a otra dirección. Tú controlas tus fondos.',
    'wd.available': 'Disponible',
    'wd.toLabel': 'Dirección de destino',
    'wd.toPlaceholder': '0x… dirección en Celo',
    'wd.toError': 'Dirección no válida',
    'wd.amountLabel': 'Monto a retirar',
    'wd.max': 'Máx',
    'wd.amountError': 'El monto supera tu saldo disponible',
    'wd.amountZero': 'Ingresa un monto mayor a cero',
    'wd.gasNote': 'Pagas la comisión de red en un stablecoin (USDT/cUSD). Necesitas un poco de saldo para cubrirla.',
    'wd.warning': 'Revisa bien la dirección: las transacciones en blockchain no se pueden revertir.',
    'wd.submit': 'Retirar Bitcoin',
    'wd.sending': 'Enviando…',
    'wd.successTitle': '¡Retiro enviado!',
    'wd.successBody': 'Tu Bitcoin va en camino a la dirección de destino.',
    'wd.viewTx': 'Ver en Celoscan',
    'wd.again': 'Hacer otro retiro',
    'wd.back': 'Volver al inicio',
    'wd.error': 'No se pudo completar el retiro. Inténtalo de nuevo.',
    'wd.gasError': 'Necesitas un poco de saldo (CELO o stablecoin) para pagar la comisión de red.',
    'wd.empty': 'No tienes Bitcoin en tu billetera para retirar.',
    'wd.noGasTitle': 'Te falta saldo para la comisión de red',
    'wd.noGasBody': 'Para mover tu Bitcoin necesitas un poco de USDT en tu billetera para pagar la comisión de red. Agrega un poco y vuelve.',
    'wd.addFunds': 'Agregar USDT',
    'status.success': 'Comprado',
    'status.skipped_no_funds': 'Sin saldo USDT',
    'status.skipped_no_allowance': 'Presupuesto agotado',
    'status.skipped_stop_loss': 'Pausada por precio',
    'status.failed': 'Fallida',
    // Plan
    'plan.title': 'Tu plan de ahorro',
    'plan.state': 'Estado',
    'plan.active': 'Activo',
    ...
    'plan.createTitle': 'Crea tu plan de ahorro',
    'plan.createSubtitle': 'Elige cuánto quieres ahorrar y cada cuánto. El agente se encarga de ejecutar las compras por ti.',
    ...
    'plan.budgetLeft': 'Presupuesto restante',
    'plan.budgetLeftValue': '{n} cuotas',
    'plan.budgetEmpty': 'El presupuesto que autorizaste ya se usó completo: el agente no puede seguir comprando hasta que autorices más.',
    'plan.budgetLow': 'Quedan pocas cuotas autorizadas — renueva el presupuesto para que el agente no se detenga.',
    'plan.edit': 'Editar plan',
    'plan.editTitle': 'Edita tu plan',
    'plan.editSubtitle': 'Cambia el monto, la frecuencia o el presupuesto. Dos firmas y el agente sigue con la nueva configuración.',
    'plan.editSubmit': 'Guardar cambios',
    'plan.editBack': 'Volver sin cambios',
    'plan.renew': 'Autorizar presupuesto para {n} cuotas',
    'plan.renewHint': 'Tu presupuesto quedará en {n} cuotas exactas (${total} USDT como máximo) — reemplaza lo que quedaba. Los fondos siguen en tu billetera.',
    'plan.renewError': 'No se pudo autorizar el presupuesto. Revisa tu billetera e intenta de nuevo.',
    ...
    'plan.whyTitle': 'Por qué ahorrar poco a poco ayuda',
    'plan.whyBody': 'Ahorrar de forma periódica convierte una decisión difícil en un hábito automático. Al comprar Bitcoin poco a poco, reduces la dependencia de un solo momento del mercado y puedes suavizar tu precio promedio.',
    'freq.3600': 'Cada hora',
    ...
    'fund.subtitle': 'El agente usa el USDT de tu billetera para ejecutar tu plan, cuota por cuota.',
    ...
    'settings.footer': 'CompraBTC · Tu agente para ahorrar en Bitcoin sobre la red Celo',
    ...
    'calc.subtitle': 'Así habría crecido un ahorro de largo plazo comprando Bitcoin automáticamente, poquito a poquito, cada hora.',
    ...
    'calc.btc0t': 'Porque una pensión puede no ser suficiente',
    'calc.btc0b': 'Los sistemas pensionales dependen de que muchas personas trabajen y coticen por cada pensionado. Con una población que envejece, conviene construir un ahorro propio que puedas empezar hoy y mantener bajo tu control.',
  ...
  en: {
    'landing.title1': 'A pension may not be enough.',
    'landing.title2': 'Your savings start today.',
    'landing.subtitle': 'As populations age, fewer workers support more retirees. That is why building savings of your own matters. CompraBTC automates small Bitcoin purchases from $0.10 USDT, straight to your wallet and within the limits you set.',
    'landing.step1': 'Connect your wallet',
    'landing.step2': 'Choose how much to save and how often',
    'landing.step3': 'The agent buys Bitcoin and sends it straight to your wallet',
    'landing.cta': 'Start my savings',
    'landing.note': 'Non-custodial: your funds stay in your wallet and are only used within the limit you authorize.',
    'landing.roadmap': 'Today, your plan uses Bitcoin. The vision is to add gold and digital dollars in the same wallet.',
    ...
    'connect.subtitle': 'Your agent automates saving from your own wallet. You set the plan and stay in control of your funds.',
    'connect.button': 'Connect wallet',
    'connect.loading': 'Loading…',
    'dash.emptyTitle': 'Your savings agent',
    ...
    'dash.vault': 'Your Bitcoin savings',
    'dash.accumulated': 'Sats stacked',
    'dash.accumulatedHint': 'bought with the app',
    'dash.inWallet': 'In your wallet now',
    ...
    'dash.loadMore': 'Show more purchases ({n} remaining)',
    'dash.withdraw': 'Withdraw',
    // Withdraw (send WBTC to an address)
    'wd.title': 'Withdraw Bitcoin',
    'wd.subtitle': 'Send your Bitcoin to another address. You control your funds.',
    'wd.available': 'Available',
    'wd.toLabel': 'Destination address',
    'wd.toPlaceholder': '0x… address on Celo',
    'wd.toError': 'Invalid address',
    'wd.amountLabel': 'Amount to withdraw',
    'wd.max': 'Max',
    'wd.amountError': 'Amount exceeds your available balance',
    'wd.amountZero': 'Enter an amount greater than zero',
    'wd.gasNote': 'You pay the network fee in a stablecoin (USDT/cUSD). You need a little balance to cover it.',
    'wd.warning': 'Double-check the address: blockchain transactions cannot be reversed.',
    'wd.submit': 'Withdraw Bitcoin',
    'wd.sending': 'Sending…',
    'wd.successTitle': 'Withdrawal sent!',
    'wd.successBody': 'Your Bitcoin is on its way to the destination address.',
    'wd.viewTx': 'View on Celoscan',
    'wd.again': 'Make another withdrawal',
    'wd.back': 'Back to home',
    'wd.error': 'Could not complete the withdrawal. Please try again.',
    'wd.gasError': 'You need a little balance (CELO or a stablecoin) to pay the network fee.',
    'wd.empty': "You don't have any Bitcoin in your wallet to withdraw.",
    'wd.noGasTitle': 'You need balance for the network fee',
    'wd.noGasBody': 'To move your Bitcoin you need a little USDT in your wallet to pay the network fee. Add some and come back.',
    'wd.addFunds': 'Add USDT',
    'status.success': 'Bought',
    'status.skipped_no_funds': 'No USDT balance',
    'status.skipped_no_allowance': 'Budget used up',
    ...
    'plan.createTitle': 'Create your savings plan',
    'plan.createSubtitle': 'Choose how much you want to save and how often. The agent takes care of executing the purchases for you.',
    ...
    'plan.budgetLeft': 'Remaining budget',
    'plan.budgetLeftValue': '{n} installments',
    'plan.budgetEmpty': "The budget you authorized is fully used: the agent can't keep buying until you authorize more.",
    'plan.budgetLow': 'Few authorized installments left — renew the budget so the agent doesn’t stop.',
    'plan.edit': 'Edit plan',
    'plan.editTitle': 'Edit your plan',
    'plan.editSubtitle': 'Change the amount, frequency or budget. Two signatures and the agent continues with the new setup.',
    'plan.editSubmit': 'Save changes',
    'plan.editBack': 'Back without changes',
    'plan.renew': 'Authorize budget for {n} installments',
    'plan.renewHint': 'Your budget will be exactly {n} installments (${total} USDT max) — it replaces what was left. Funds stay in your wallet.',
    'plan.renewError': "Couldn't authorize the budget. Check your wallet and try again.",
    ...
    'plan.whyTitle': 'Why saving little by little helps',
    'plan.whyBody': 'Saving regularly turns a difficult decision into an automatic habit. By buying Bitcoin little by little, you depend less on a single market moment and may smooth your average purchase price.',
    ...
    'fund.subtitle': 'The agent uses the USDT in your wallet to execute your plan, installment by installment.',
    ...
    'settings.footer': 'CompraBTC · Your agent for saving in Bitcoin on the Celo network',
    ...
    'calc.subtitle': 'This is how long-term savings would have grown by buying Bitcoin automatically, little by little, every hour.',
    ...
    'calc.btc0t': 'Because a pension may not be enough',
    'calc.btc0b': 'Pension systems depend on many people working and contributing for every retiree. As populations age, it makes sense to build savings of your own that you can start today and keep under your control.',
