...
const dict = {
  es: {
    ...
    'plan.stopLossLabel': 'Pausar si Bitcoin cae (%) — opcional',
    'plan.stopLossHint': 'Si el precio cae este porcentaje frente a tu precio promedio, el agente pausa nuevas compras.',
    ...
    'calc.subtitle': 'Calcula cuánto Bitcoin tendrías hoy si hubieras comprado poco a poco, sin pensarlo.',
    'calc.amountLabel': '¿Cuánto habrías comprado cada vez? (USD)',
    'calc.freqLabel': '¿Con qué frecuencia?',
    'calc.freqWeekly': 'Cada semana',
    'calc.freqMonthly': 'Cada mes',
    'calc.periodLabel': '¿Desde hace cuánto?',
    'calc.period1': 'Hace 1 año',
    'calc.period3': 'Hace 3 años',
    'calc.period5': 'Hace 5 años',
    'calc.button': 'Calcular',
    'calc.loading': 'Calculando con precios históricos reales…',
    'calc.invested': 'Habrías invertido',
    'calc.wouldHave': 'Tendrías hoy',
    'calc.worth': 'Valor actual',
    'calc.change': 'Diferencia',
    'calc.cta': 'Empieza hoy — crea tu plan',
    'calc.disclaimer': 'Cálculo con precios históricos reales de Bitcoin (CoinGecko). El comportamiento pasado no garantiza resultados futuros.',
  ...
  en: {
    ...
    'plan.stopLossLabel': 'Pause if Bitcoin drops (%) — optional',
    'plan.stopLossHint': 'If the price drops by this percentage versus your average price, the agent pauses new purchases.',
    ...
    'calc.subtitle': 'See how much Bitcoin you would have today by buying little by little, without thinking about it.',
    'calc.amountLabel': 'How much would you have bought each time? (USD)',
    'calc.freqLabel': 'How often?',
    'calc.freqWeekly': 'Every week',
    'calc.freqMonthly': 'Every month',
    'calc.periodLabel': 'Starting when?',
    'calc.period1': '1 year ago',
    'calc.period3': '3 years ago',
    'calc.period5': '5 years ago',
    'calc.button': 'Calculate',
    'calc.loading': 'Calculating with real historical prices…',
    'calc.invested': 'You would have invested',
    'calc.wouldHave': "You'd have today",
    'calc.worth': 'Current value',
    'calc.change': 'Difference',
    'calc.cta': 'Start today — create your plan',
    'calc.disclaimer': 'Calculated with real historical Bitcoin prices (CoinGecko). Past performance does not guarantee future results.',
