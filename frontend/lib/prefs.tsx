...
const dict = {
  es: {
    ...
    'settings.telegramBody': 'Abre nuestro bot y toca “Iniciar”: quedará vinculado a tu billetera y te llegará un mensaje a tu Telegram cada vez que el agente compre por ti.',
  ...
  en: {
    ...
    'settings.telegramBody': 'Open our bot and tap “Start”: it links to your wallet and messages your Telegram every time the agent buys for you.',
