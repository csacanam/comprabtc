...
const dict = {
  es: {
    ...
    'plan.feeNote': 'El contrato no permite cobrar más comisión de la mostrada — verifícalo on-chain.',
    ...
    'calc.why2b': 'Tu Bitcoin llega a tu propia billetera, no se queda en una plataforma. Ni siquiera nuestro agente puede tocarlo: solo puede comprar dentro del presupuesto que tú autorizaste, y puedes cancelar cuando quieras.',
  ...
  en: {
    ...
    'plan.feeNote': "The contract can't charge more commission than shown — verify it on-chain.",
    ...
    'calc.why2b': "Your Bitcoin lands in your own wallet — it never sits on a platform. Not even our agent can touch it: it can only buy within the budget you authorized, and you can cancel anytime.",
