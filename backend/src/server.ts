...
function nextRun(plan: db.PlanRow): Date {
  // Ancla por ejecución (= reloj del contrato: lastRun + minInterval).
  // Mantener una fase de reloj fija ("siempre a las y 15") pelea contra ese
  // ancla y cuesta compras saltadas o reintentos x402 — se prefiere maximizar
  // el número de compras. Efecto cosmético aceptado: si el keeper estuvo
  // caído, los planes vencidos se ejecutan juntos y quedan en fase similar.
